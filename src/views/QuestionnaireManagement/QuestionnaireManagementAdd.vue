    ...
    <div style="width: 80%;margin: 0 auto;">
        <el-form :inline="true" :model="Questionnaire" class="demo-form-inline">
            ...
            <div style="margin-bottom: 15px">
                ...
                <el-table ref="multipleTable" :data="QuestionDataList" border tooltip-effect="dark" height="300" style="width: 77.6%;">
                    <el-table-column label="问卷问题">
                        ...
                        <el-table-column label="操作"      width="100">
                            <template slot-scope="scope">
                                <el-button @click.native.prevent="updataAddQuestionnaires(scope.$index, QuestionDataList)" type="text" size="small">修改</el-button>
                                <el-button @click.native.prevent="deleteAddQuestion(scope.$index, QuestionDataList)" type="text" size="small">移除</el-button>
                            </template>
                        </el-table-column>
                    </el-table-column>
                </el-table>
        ...
        <el-dialog title="添加问题" :visible.sync="outerVisibleFile">
            <el-form ref="form" :model="Question" label-width="auto">
                ...
                <el-form-item label="问题内容：">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <el-input type="textarea" :rows="2" width="100" placeholder="问题内容" v-model="Question.content"></el-input>
                </el-form-item>
                ...
                <el-table ref="multipleTable" :data="answerDataList" border tooltip-effect="dark" height="200" style="width: 97%;">
                    ...
                    <el-table-column label="操作"      width="80">
                        <template slot-scope="scope">
                            <el-button @click.native.prevent="deleteAnswerData(scope.$index, answerDataList)" type="text" size="small">移除</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </el-form>
        ...
        <el-dialog title="添加问题答案" :visible.sync="outerAnswer">
            <el-form ref="form" :model="answerData" label-width="auto">
                <el-form-item label="选项代码：">
                    <el-input type="textarea" :rows="2" width="100" placeholder="选项代码" v-model="answerData.code"></el-input>
                </el-form-item>
                <el-form-item label="选项内容：">
                    <el-input type="textarea" :rows="2" width="100" placeholder="选项内容" v-model="answerData.content"></el-input>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
